...
public class Diamond extends Game {
	...
	public static void debug() {
		...
		d.gameInit();
		d.game();
		int player1_score =  d.hm.get(PLAYER1);
		int player2_score =  d.hm.get(PLAYER2);
		Benchmark.computeBenchmark(player1_score, player2_score);
		float benchmark = Benchmark.returnBenchmark();
